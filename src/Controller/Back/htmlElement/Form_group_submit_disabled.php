...
*/
class Form_group_submit_disabled{
    ...
    $form_group_submit.=      '<input id="'.$this->name_submit.'" type="submit" class="'.$this->class_submit.' col-md-12" value="'.$this->value_submit.'" name="'.$this->name_submit.'" disabled>';
