...
*/
class Form_group_input_disabled{
    ...
    $form_group_input.=     '<input type="text" class="form-control" placeholder="'.$this->placeholder.'" name="'.$this->name.'" value="'.$this->value.'" disabled></input>';
